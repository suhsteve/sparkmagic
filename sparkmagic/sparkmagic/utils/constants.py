...
SESSION_KIND_SPARKDOTNET = "sparkdotnet"
SESSION_KINDS_SUPPORTED = [SESSION_KIND_SPARK, SESSION_KIND_PYSPARK, SESSION_KIND_SPARKR, SESSION_KIND_SPARKDOTNET]
...
LANG_R = "r"
LANG_CSHARP = "csharp"
LANGS_SUPPORTED = [LANG_SCALA, LANG_PYTHON, LANG_R, LANG_CSHARP]
